...
function validateState(state) {
  ...
  if (!Array.isArray(state.tasks) || !Array.isArray(state.devices) || !Array.isArray(state.changes)) {
    throw new Error("PhoneDex store tasks, devices, and changes must be arrays");
  }
