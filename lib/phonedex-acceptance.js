...
function normalizePlatforms(value) {
  ...
  return { platforms: platforms.slice(0, 3), invalidPlatforms };
}
...
module.exports = { DEFAULT_MAX_AGE_DAYS, MAX_RECORDS, REQUIRED_SCENARIOS, SCHEMA, evaluateAcceptanceEvidence };
