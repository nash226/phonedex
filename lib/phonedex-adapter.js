...
const ADAPTER_CAPABILITIES = Object.freeze([
  ...
  { id: "task.approve", version: "1", scope: "task" },
...
function createCodexAdapter({
  ...
  limitations.push("Task creation, cancellation, retry, approval, and desktop handoff are not claimed by this adapter.");

  const capabilities = ADAPTER_CAPABILITIES.map((definition) => protocolRecord("capability", {
    ...definition,
    supported: ready && definition.id === "task.reply"
  }));
