...
The alert intentionally points to `/agent-bootstrap/setup` without embedding
your hub token in visible notification text. Add
`?token=YOUR_WATCH_BRIDGE_TOKEN` from the hub `.env` when opening that setup
page from a trusted device.
