...
const assertions = [
  ["cache restore is isolated behind a throwing boundary", model, /private func restoreCachedState\(\)\s*\{\s*do \{/s],
  ["cache failures quarantine the persisted file", model, /catch \{[\s\S]{0,1200}?try\? cache\.quarantine\(\)/],
